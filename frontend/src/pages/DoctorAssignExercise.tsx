      ...
      <div className="max-w-6xl mx-auto mb-8 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm">
            Select and configure the recovery plan.
          </p>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {exerciseLibrary.map((ex) => (
              <div
                key={ex.id}
                className="bg-white p-5 rounded-xl border border-slate-100 shadow-sm hover:border-teal-200 hover:shadow-md transition-all group relative"
              >
              ...
              <div className="max-h-[400px] overflow-y-auto p-4 space-y-4">
                {selectedExercises.length === 0 ? (
                  ...
                  selectedExercises.map((item) => (
                    <div
                      key={item.id}
                      className="border border-slate-100 rounded-xl p-3 relative bg-slate-50/30"
                    >
                      <button
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center bg-white border border-slate-200 rounded-lg px-2 py-1">
                            ...
                            <input
                              ...
                              value={item.sets}
                              onChange={(e) =>
                                updateField(item.id, "sets", e.target.value)
                              }
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center bg-white border border-slate-200 rounded-lg px-2 py-1">
                            ...
                            <input
                              ...
                              value={item.reps}
                              onChange={(e) =>
                                updateField(item.id, "reps", e.target.value)
                              }
                              className="w-full text-sm font-bold text-slate-900 focus:outline-none"
                            />
                          </div>
