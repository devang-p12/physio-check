      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#1D3557] via-[#1D3557] to-[#457B9D] flex-col p-16 relative overflow-hidden">
        ...
        <div className="relative z-10 mt-20 flex-1 flex flex-col justify-center max-w-xl">
          <h1 className="text-5xl font-black text-[#F1FAEE] leading-[1.15] tracking-tight mb-8">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#A8DADC] to-[#F1FAEE]">Start Your</span> Journey <br/>
            to Better Recovery.
          </h1>
          <p className="text-[#A8DADC] opacity-90 text-xl mb-8 font-medium leading-relaxed">
            Join thousands of patients and clinicians using our clinical-grade AI platform for precise motion tracking and insights.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center bg-[#F1FAEE] p-6 sm:p-12 lg:p-24 relative overflow-hidden">
        ...
        <div className="max-w-[440px] w-full mx-auto relative z-10">
          ...
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-4xl font-black text-[#1D3557] mb-3 tracking-tight">Create your account</h2>
            <p className="text-[#457B9D] text-lg font-medium">Please fill in your details to get started.</p>
          </div>
          ...
          <div className="bg-white/60 backdrop-blur-xl border border-white p-8 rounded-3xl shadow-xl shadow-[#1D3557]/5">
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div>
                <label className="text-[11px] font-bold uppercase tracking-wider text-[#1D3557] block mb-2 px-1">I am a...</label>
                <div className="relative flex p-1.5 bg-[#F1FAEE] border border-[#A8DADC]/30 rounded-full shadow-inner overflow-hidden">
                  <div 
                  ...
                  <button
                    ...
                    className={`relative z-10 flex-1 py-3 rounded-full text-[13px] uppercase tracking-widest font-black transition-colors flex items-center justify-center gap-2 ${role === "doctor" ? "text-[#F1FAEE]" : "text-[#457B9D] hover:text-[#A8DADC]"}`}
                  >
              ...
              <div className="space-y-5">
                <div>
                  <label className="text-[11px] font-bold uppercase tracking-wider text-[#1D3557] block mb-2 px-1">Full Name</label>
                  <div className="relative group">
                    <User className="absolute left-4 top-1/2 -translate-y-1/2 text-[#457B9D]/60 transition-colors group-focus-within:text-[#457B9D]" size={20} />
                    <input
                      type="text"
                      name="name"
                      value={formData.name}
          ...
          <p className="mt-10 text-center text-[15px] font-semibold text-[#457B9D]">
            ...
            <Link to="/login" className="text-[#1D3557] hover:underline normal-case tracking-normal transition-colors">
              Log in
            </Link>
          </p>
