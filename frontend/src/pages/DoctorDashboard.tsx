...
const DoctorDashboard = () => {
  ...
  const stats = [
    { label: 'Total Patients', value: '24', icon: Users, color: 'text-blue-600', bg: 'bg-blue-50', trend: '+4 this week' },
    { label: 'Active Plans', value: '18', icon: Activity, color: 'text-teal-600', bg: 'bg-teal-50', trend: '92% adherence' },
    { label: 'Today\'s Sessions', value: '06', icon: Calendar, color: 'text-purple-600', bg: 'bg-purple-50', trend: '2 remaining' },
  ];

  const patients = [
    { id: 1, name: 'Sarah Jenkins', condition: 'ACL Reconstruction', progress: 75, status: 'On Track', lastSeen: '2 days ago' },
    { id: 2, name: 'Michael Chen', condition: 'Rotator Cuff Tear', progress: 45, status: 'Needs Attention', lastSeen: '1 day ago' },
    { id: 3, name: 'Emma Wilson', condition: 'Lower Back Pain', progress: 90, status: 'Recovery Phase', lastSeen: '4 hours ago' },
    { id: 4, name: 'James Rodri', condition: 'Ankle Sprain', progress: 20, status: 'New Patient', lastSeen: 'Just now' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-slate-900 tracking-tight">PhysioCheck</span>
            </div>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                <div className="text-right hidden sm:block">
                  <p className="text-sm font-semibold text-slate-900">Dr. Alex P.</p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {patients.map((patient) => (
            <div key={patient.id} className="group bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-full ${
                    patient.status === 'Needs Attention' ? 'bg-red-50 text-red-600' : 'bg-slate-100 text-slate-600'
                  }`}>
                    {patient.status}
                  </span>
                </div>
                ...
                <div className="mb-6">
                  <div className="flex justify-between text-xs mb-2">
                    <span className="font-semibold text-slate-700">Recovery Progress</span>
                    <span className="text-teal-600 font-bold">{patient.progress}%</span>
                  </div>
              ...
              <div className="px-6 py-3 bg-slate-50 border-t border-slate-100 flex items-center gap-2">
                ...
                <span className="text-xs text-slate-400 font-medium">Last active: {patient.lastSeen}</span>
              </div>
            </div>
          ))}
